  ...
  return (
    <div className="flex justify-center">
      <div className="relative w-[210px] border p-5 rounded-xl hover:shadow-md transition hover:-translate-y-1.5">
        ...
        <button
          onClick={() => toast.success('Товар добавлен в Закладки!')}
          className="absolute left-5 top-5  w-8 h-8 bg-primary/5 hover:bg-primary/10 border rounded-md flex items-center justify-center cursor-pointer active:scale-95"
        >
